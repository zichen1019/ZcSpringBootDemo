<template>
  <div class="social-signup-container">
    <div class="sign-btn" @click="registerHandleClick">
      <span class="register-svg-container"><svg-icon icon-class="user" class="icon"/></span> {{ $t('register.register') }}
    </div>
